...
3.  This is an example of the output of running the above command

    ![](images/create_ns6.png)

4.	Create the namespace as assigned by your trainer.

    ```bash
    kubectl create namespace devops<as assigned by your trainer>

5.  This is an example of the output of running the above command
